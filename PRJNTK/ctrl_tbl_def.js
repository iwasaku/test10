...
const ctrlTable = [
    ...
    [
        ...
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128, yPos: 0 - 64 - (128 + 32) * 3 } },
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128 * 2, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128 * 2, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128 * 2, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: SCREEN_WIDTH - 128 * 2, yPos: 0 - 64 - (128 + 32) * 3 } },

        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128, yPos: 0 - 64 - (128 + 32) * 3 } },
        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128 * 2, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128 * 2, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128 * 2, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 120, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0 + 128 * 2, yPos: 0 - 64 - (128 + 32) * 3 } },
        ...
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 3, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 2, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 1, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 0, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 1, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 2, yPos: 0 - 64 - (128 + 32) * 0 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 3, yPos: 0 - 64 - (128 + 32) * 0 } },

        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 2.5, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 1.5, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 0.5, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 0.5, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 1.5, yPos: 0 - 64 - (128 + 32) * 1 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 2.5, yPos: 0 - 64 - (128 + 32) * 1 } },

        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 3, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 2, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 1, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 0, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 1, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 2, yPos: 0 - 64 - (128 + 32) * 2 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 3, yPos: 0 - 64 - (128 + 32) * 2 } },

        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 2.5, yPos: 0 - 64 - (128 + 32) * 3 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 1.5, yPos: 0 - 64 - (128 + 32) * 3 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 0.5, yPos: 0 - 64 - (128 + 32) * 3 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 0.5, yPos: 0 - 64 - (128 + 32) * 3 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 1.5, yPos: 0 - 64 - (128 + 32) * 3 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 2.5, yPos: 0 - 64 - (128 + 32) * 3 } },

        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 3, yPos: 0 - 64 - (128 + 32) * 4 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 2, yPos: 0 - 64 - (128 + 32) * 4 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X - 120 * 1, yPos: 0 - 64 - (128 + 32) * 4 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 0, yPos: 0 - 64 - (128 + 32) * 4 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 1, yPos: 0 - 64 - (128 + 32) * 4 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 2, yPos: 0 - 64 - (128 + 32) * 4 } },
        { count: 2400, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_2, xPos: SCREEN_CENTER_X + 120 * 3, yPos: 0 - 64 - (128 + 32) * 4 } },
    ...
    [
        ...
        { count: 60, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0, yPos: 0 } },
        { count: 660, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0, yPos: 0 } },
        { count: 1260, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0, yPos: 0 } },
        { count: 1860, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0, yPos: 0 } },
        { count: 2460, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0, yPos: 0 } },
        { count: 3060, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0, yPos: 0 } },
        { count: 3660, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_0, xPos: 0, yPos: 0 } },
