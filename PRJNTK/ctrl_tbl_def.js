...
const ctrlTable = [
    ...
    [
        ...
        // ボス
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 90 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 270 } },
    ...
    [
        ...
        // ボス
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS05, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 3200 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
    ...
    [
        ...
        // ボス
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 60 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 120 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 240 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 300 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS06, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 3200 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
    ],
    // STG7
    [
        ...
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 270 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 90 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 270 } },
        { count: 3200, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS07, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 3200 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
    ],
    // STG8
    [
        ...
        // ボス
        { count: 120, cmd: CMD.SET_BOSSSRUSH, param: {} },

        { count: 120 + 60 * 0, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS01, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 120 + 60 * 0 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
        { count: 120 + 60 * 0 + 2, cmd: CMD.START_SCROLL, param: { idx: 1 } },

        { count: 120 + 60 * 2, cmd: CMD.STOP_SCROLL, param: { idx: 1 } },
        { count: 120 + 60 * 2, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS02, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 120 + 60 * 2 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
        { count: 120 + 60 * 2 + 2, cmd: CMD.START_SCROLL, param: { idx: 1 } },

        { count: 120 + 60 * 4, cmd: CMD.STOP_SCROLL, param: { idx: 1 } },
        { count: 120 + 60 * 4, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS03, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 120 + 60 * 4 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
        { count: 120 + 60 * 4 + 2, cmd: CMD.START_SCROLL, param: { idx: 1 } },

        { count: 120 + 60 * 6, cmd: CMD.STOP_SCROLL, param: { idx: 1 } },
        { count: 120 + 60 * 6, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 120 + 60 * 6, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 60 } },
        { count: 120 + 60 * 6, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 120 } },
        { count: 120 + 60 * 6, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 120 + 60 * 6, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 240 } },
        { count: 120 + 60 * 6, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 300 } },
        { count: 120 + 60 * 6, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS01MOD, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 120 + 60 * 6 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
        { count: 120 + 60 * 6 + 2, cmd: CMD.START_SCROLL, param: { idx: 1 } },

        { count: 120 + 60 * 8, cmd: CMD.STOP_SCROLL, param: { idx: 1 } },
        { count: 120 + 60 * 8, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 120 + 60 * 8, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 60 } },
        { count: 120 + 60 * 8, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 120 } },
        { count: 120 + 60 * 8, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 120 + 60 * 8, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 240 } },
        { count: 120 + 60 * 8, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 300 } },
        { count: 120 + 60 * 8, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS02MOD, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 120 + 60 * 8 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
        { count: 120 + 60 * 8 + 2, cmd: CMD.START_SCROLL, param: { idx: 1 } },

        { count: 120 + 60 * 10, cmd: CMD.STOP_SCROLL, param: { idx: 1 } },
        { count: 120 + 60 * 10, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 120 + 60 * 10, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 60 } },
        { count: 120 + 60 * 10, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 120 } },
        { count: 120 + 60 * 10, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 120 + 60 * 10, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 240 } },
        { count: 120 + 60 * 10, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 300 } },
        { count: 120 + 60 * 10, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS03MOD, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 120 + 60 * 10 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
        { count: 120 + 60 * 10 + 2, cmd: CMD.START_SCROLL, param: { idx: 1 } },

        { count: 120 + 60 * 12, cmd: CMD.STOP_SCROLL, param: { idx: 1 } },
        { count: 120 + 60 * 12, cmd: CMD.RESET_BOSSSRUSH, param: {} },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 90 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO01, xPos: SCREEN_CENTER_X, yPos: -128, deg: 270 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 0 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 90 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 180 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS_ZAKO02, xPos: SCREEN_CENTER_X, yPos: -128, deg: 270 } },
        { count: 120 + 60 * 12, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS04, xPos: SCREEN_CENTER_X, yPos: -128 } },
        { count: 120 + 60 * 12 + 1, cmd: CMD.STOP_CTRL_COUNTER, param: {} },
    ],
];
