...
const ctrlTable = [
    ...
    //
    //        // ボス
    //        { count: 180, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.BOSS02, xPos: SCREEN_CENTER_X, yPos: -128 } },
    //
    //        // 無限に雑魚を出現させる
    //        { count: 180 + 60, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_1, xPos: 128 + 128 * 0, yPos: -64 } },
    //        { count: 180 + 60, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_1, xPos: 128 + 128 * 1, yPos: -64 * 5 } },
    //        { count: 180 + 60, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_1, xPos: 128 + 128 * 2, yPos: -64 * 3 } },
    //        { count: 180 + 60, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_1, xPos: 128 + 128 * 3, yPos: -64 * 9 } },
    //        { count: 180 + 60, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_1, xPos: 128 + 128 * 4, yPos: -64 * 11 } },
    //        { count: 180 + 60, cmd: CMD.SET_ENEMY, param: { loop: 0, define: EN_DEF.ENEMY00_1, xPos: 128 + 128 * 5, yPos: -64 * 7 } },
    //
    //        { count: 180 + 60 * 5, cmd: CMD.SET_CTRL_COUNTER, param: { cnt: 180 + 59 } },
    //    ],
    // STG1
    [
    ...
    [
        ...
        { count: 900, cmd: CMD.SET_SCROLL_DATA, param: { idx: 0, sprName: "stg03", yPos: -SCREEN_HEIGHT * 1.5, ySize: 1600 * 5 } },
    ...
    [
        ...
        { count: 900, cmd: CMD.SET_SCROLL_DATA, param: { idx: 1, sprName: "stg04", yPos: -SCREEN_HEIGHT * 1.5, ySize: 1600 * 5 } },
